...
\begin{figure}[htb]
	...
	\end{tabular}
	\caption{Narzędzia dostępne w aplikacji TrueFire: a) stroik, b) eksplorator akordów, c) metronom, d) księga akordów, e) diagram skal} \label{fig:truefire} % DONE: etykiety nie mogą się powtarzać !!!!!
\end{figure}
