...
Do najpopularniejszych aplikacji tego typu należą \texttt{Yousician} \cite{https://yousician.com} czy \texttt{Fret Trainer} \cite{https://fretmaster.app/}. % DONE1/2 nie dodano cytowania w .bib: dołożyć cytowania (do opisów tych aplikacji, manuali czy książek
