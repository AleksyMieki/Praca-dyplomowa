...
\titleShort{Aplikacja do rozwijania potencjału muzycznego gitarzystów}  % INFO: krótki tytuł pracy (do zamieszczenia w stopce, sklejony z imieniem i nazwiskiem autora nie powinien zająć więcej niż jedną linijkę)
\titleEN{Design of an app to develop the musical potential of guitarists} % INFO: tytuł pracy w języku angielskim
...
\kvpl{gra na gitarze, edukacja muzyczna, silnik Unity} % INFO: słowa kluczowe po polsku
\kven{guitar playing, music education, Unity engine} % INFO: słowa kluczowe po angielsku
